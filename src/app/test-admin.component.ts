        ...
        <div class="p-8">
            ...
            <div class="mt-6 p-4 bg-blue-50 rounded-lg">
                ...
                <ul class="mt-2 space-y-2">
                    <li>✅ <a routerLink="/sign-up/admin-dashboard" class="text-pantone-teal-dark hover:underline">Public Admin Dashboard</a> - No auth required</li>
                    <li>🔐 <a routerLink="/admin" class="text-pantone-teal-dark hover:underline">Protected Admin Dashboard</a> - Requires login</li>
                    <li>🔑 <a routerLink="/sign-in" class="text-pantone-teal-dark hover:underline">Login Page</a> - Use admin credentials below</li>
                </ul>
            </div>
            ...
            <div class="mt-6 p-4 bg-yellow-50 rounded-lg">
                ...
                <ol class="mt-2 space-y-1 list-decimal list-inside">
                    ...
                    <li>Go to the <a routerLink="/sign-in" class="text-pantone-teal-dark hover:underline">Login Page</a></li>
