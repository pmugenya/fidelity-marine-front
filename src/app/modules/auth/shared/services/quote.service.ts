...
import { PaybillResponse, QuotesData } from '../../../../core/user/user.types';
...
export class QuoteService {
    ...
    validatePaybillTransaction(reference: string): Observable<PaybillResponse> {
        const params = new HttpParams().set('reference', reference);
        return this.http.get<any>(`${this.baseUrl}/paymentslog/validategibpayment`, { params });
    }

    savePaybillPayment(paymentData: any): Observable<any> {
        return this.http.post<any>(`${this.baseUrl}/paymentslog`, paymentData);
    }
