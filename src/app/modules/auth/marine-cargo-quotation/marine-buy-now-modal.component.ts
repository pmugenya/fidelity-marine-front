...
@Component({
    ...
    styles: [`
        :host {
            --primary-color: #00787C; /* Pantone 328U - Teal */
            --secondary-color: #B8D432; /* Pantone 366C - Lime Green */
        ...
        ::ng-deep .mat-mdc-button.mat-primary {
            --mdc-text-button-label-text-color: #B8D432 !important;
            color: #B8D432 !important;
            font-weight: 600 !important;
        }

        ::ng-deep .mat-mdc-button.mat-primary:hover {
            background-color: rgba(184, 212, 50, 0.1) !important;
        }

        /* Checkbox Styling - Teal */
        ::ng-deep .mat-mdc-checkbox.mat-primary {
            --mdc-checkbox-selected-checkmark-color: white !important;
            --mdc-checkbox-selected-icon-color: #00787C !important;
            --mdc-checkbox-selected-hover-icon-color: #00787C !important;
            --mdc-checkbox-selected-pressed-icon-color: #00787C !important;
        }

        ::ng-deep .mat-mdc-checkbox.mat-primary .mdc-checkbox__background {
            border-color: #00787C !important;
        }
        ...
        /* Override Material Select Focus - Lime Green */
        ...
        .pay-now-button:hover:not([disabled]) {
            ...
            box-shadow: 0 6px 20px rgba(0, 120, 124, 0.4) !important;
        ...
        @media (max-width: 768px) {
            ...
            .modal-content {
                ...
                scrollbar-color: #00787C #f1f5f9 !important;
            }
            ...
            <div class="modal-content">
                <div class="overflow-y-auto max-h-[60vh] text-sm text-gray-700 space-y-4 p-6">
                    ...
                    <div>
                        ...
                        <p>For more detailed information about our data processing practices, please visit: <a href="https://geminia.co.ke/data-privacy-statement/" target="_blank" class="text-pantone-teal-dark hover:underline">https://geminia.co.ke/data-privacy-statement/</a></p>
                    </div>
