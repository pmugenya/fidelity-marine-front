# PowerShell script to update all logo references from .png to .svg

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Updating Logo References to SVG" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
foreach ($file in $files) {
    if (Test-Path $file) {
        ...
        $beforeCount = ([regex]::Matches($content, 'images/logo/logo\.png')).Count
        
        # Replace logo.png with logo.svg
        $newContent = $content -replace 'images/logo/logo\.png', 'images/logo/logo.svg'
...
Write-Host "All logo references now point to SVG!" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "NEXT STEPS:" -ForegroundColor Yellow
Write-Host "1. Save the Fidelity logo SVG file" -ForegroundColor White
Write-Host "2. Place it in: public\images\logo\logo.svg" -ForegroundColor White
