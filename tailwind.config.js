...
const config = {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        gray: colors.slate,
        // GEMINIA PANTONE COLOR SCHEME - Replaces all blue colors
        "pantone-teal": "#00787C",      // Pantone 328U - Primary brand color
        "pantone-lime": "#B8D432",      // Pantone 366C - Accent color
        "pantone-teal-dark": "#005A5D", // Darker teal for hover states
        "pantone-teal-light": "#00A3A8",// Lighter teal for backgrounds
        "pantone-dark": "#21275c",      // Secondary dark (limited use)
        // Utility colors
